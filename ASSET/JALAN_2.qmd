...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" name="File Geodatabase Feature Class" type="Local Area Network" description="" size="" format="" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
